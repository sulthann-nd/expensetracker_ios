...
struct DashboardView: View {
    @StateObject private var controller = DashboardController(context: PersistenceController.shared.container.viewContext)
    ...
    private var addExpenseButton: some View {
        Button {
            controller.isPresentingAdd = true
        } label: {
            HStack(spacing: 12) {
        ...
        .buttonStyle(.plain)
        .padding(.horizontal)
        .fullScreenCover(isPresented: $controller.isPresentingAdd) {
            NavigationStack {
                AddExpenseView()
                    ...
                    .toolbar {
                        ...
                        ToolbarItem(placement: .navigationBarLeading) {
                            Button {
                                controller.isPresentingAdd = false
                            } label: {
